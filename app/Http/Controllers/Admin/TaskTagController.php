...
class TaskTagController extends Controller
{
    ...
    {
        abort_if(Gate::denies('task_tag_access'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_tag_create'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_tag_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_tag_show'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
