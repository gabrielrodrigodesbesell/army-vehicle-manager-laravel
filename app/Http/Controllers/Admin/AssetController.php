...
class AssetController extends Controller
{
    ...
    {
        abort_if(Gate::denies('asset_access'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_create'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_show'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_delete'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_create') && Gate::denies('asset_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
