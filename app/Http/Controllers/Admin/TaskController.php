...
class TaskController extends Controller
{
    ...
    {
        abort_if(Gate::denies('task_access'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_create'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_show'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_delete'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('task_create') && Gate::denies('task_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
