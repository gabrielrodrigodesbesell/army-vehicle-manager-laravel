...
class AssetCategoryController extends Controller
{
    ...
    {
        abort_if(Gate::denies('asset_category_create'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
    ...
    {
        abort_if(Gate::denies('asset_category_edit'), Response::HTTP_FORBIDDEN, trans('global.http_error_403'));
